###########################################################################
## Makefile generated for component 'posRegler'. 
## 
## Makefile     : posRegler.mk
## Generated on : Thu Jun 11 15:34:44 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\posRegler.exe
...
PRODUCT_NAME              = posRegler
MAKEFILE                  = posRegler.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2021a
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2021a\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = D:\tmp\maowit00\rt2-lab\Lab2_Modell
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = posRegler_comp.rsp
CMD_FILE                  = posRegler.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\posRegler.exe
...
DEFINES_STANDARD = -DMODEL=posRegler -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\posRegler_ert_rtw\posRegler.c
...
{$(START_DIR)\posRegler_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\posRegler_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
posRegler.obj : $(START_DIR)\posRegler_ert_rtw\posRegler.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\posRegler_ert_rtw\posRegler.c
