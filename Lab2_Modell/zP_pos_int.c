...
// *******************************************************************************************
// Verwenden Sie diese vordefinierten Datentypen f�r Integergr��en
#define int8    char
#define int16   short
#define int32   long
...
#define POS_Np    7       // Skalierungsfaktor f�r Positionsregler
#define POS_Np1   3       // Skalierungsfaktor f�r Positionsregler
...
{   
    ...
    if(init){
        ...
        // S�ttigung Regelfehler
        e_position = (e_position >  56000000) ?  56000000 : e_position;
        e_position = (e_position < -56000000) ? -56000000 : e_position;

        set_rpm    = (kp_pos_N * e_position) >> POS_Np1;
    }
    // Stellgr��enbeschr�nkung durch nachfolgendes S�ttigungselement in Simulink
    *u = (double) set_rpm;
}
