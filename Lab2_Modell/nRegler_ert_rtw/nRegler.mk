###########################################################################
## Makefile generated for component 'nRegler'. 
## 
## Makefile     : nRegler.mk
## Generated on : Thu Jun 11 15:22:46 2026
...
COMPILER_COMMAND_FILE     = nRegler_comp.rsp
CMD_FILE                  = nRegler.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
DEFINES_STANDARD = -DMODEL=nRegler -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
{$(START_DIR)\nRegler_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\nRegler_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
