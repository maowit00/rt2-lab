...
#define INCREMENT_RPM            100L  // increment to ramp up or down set speed [U/min]
#define MAX_RPM                 7800L  // max speed
#define MIN_RPM                -7800L  // min speed
...
#define CONV_ADC_N_SHIFT         4
#define CONV_ADC_RPM_UPMIN       ((uint8)(1000*5/(1023*2*0.16)*(1<<CONV_ADC_N_SHIFT)))  // 15.273*16=244 
/* Internal RPM values set_rpm and measured_rpm = RPM in U/min * 16 / CONV_ADC_RPM_UPMIN
                                   e.g. 4000 U/min -->  262
                                        7800 Z/min -->  511
*/
...
#define CONV_ADC_I_SHIFT         7
#define CONV_ADC_I_mA            ((uint8)((0.1*4*5/1023*1000)*(1<<CONV_ADC_I_SHIFT)))
...
#define I2_DT_MAX    (int32)(0.2 *1e12/RTI_PERIOD_US)  // maximum value of integral I^2dt in [mA^2 us/us]
...
#define WAV_GEN_HIGH_LEVEL_RPM  3000L  // high level for RPM steering [-8000 .. +8000]
#define WAV_GEN_LOW_LEVEL_RPM   1000L  // low  level for RPM steering [-8000 .. +8000]
...
#define CONV_TTL_RPM      ((uint16) (60.0 / 100.0 * 24e6 / 16 / (CONV_ADC_RPM_UPMIN/(1<<CONV_ADC_N_SHIFT))))  
