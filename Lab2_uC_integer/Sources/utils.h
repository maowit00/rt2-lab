...
//#undef USE_OSZI                               // uncomment to remove oszi code
  ...
  #define OSZI_TRIG_MARGIN           10         // trigger safety margin for trigger edge detection
     ...
     //#define OSZI_DATA_CH1 (((int32)measured_current * CONV_ADC_I_mA)/(1<<CONV_ADC_I_SHIFT))    // casted to int16
     #define OSZI_DATA_CH2 (((int32)measured_rpm * CONV_ADC_RPM_UPMIN)/(1<<CONV_ADC_N_SHIFT))   // casted to int16
